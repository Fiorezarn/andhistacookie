    ...
    <div class="container">
        <div class="row" >
            <div class="col-md-6 img-produk">
                <img src="{{ url('fotokue/' . $product->photo) }}" alt="{{ $product->namakue }}" class=" h-auto rounded-t-lg">       
            </div>
            <div class="col-md-6 text-justify">
                ...
                <div class="mt-6">
                    ...
                    @auth
                    <a href="/pembayaranproduct/{{$product ->id}}">Beli Sekarang</a>
                    @else
                    <a href="/login">Beli Sekarang</a>    
                    @endauth
